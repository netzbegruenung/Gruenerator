...
export const clientConfigTool = {
  ...
  description:
    'Generiert eine fertige Konfiguration für verschiedene MCP-Clients (Claude Desktop, Cursor, VS Code). Gibt JSON zurück, das direkt in die jeweilige Config-Datei eingefügt werden kann.',

  inputSchema: {
    client: z
      .enum(['claude', 'cursor', 'vscode', 'chatgpt'])
      .describe(
        'Für welchen Client die Config generiert werden soll: claude, cursor, vscode, oder chatgpt'
      ),
  },
