...
const TemplateResultLightbox = ({ isOpen, onClose, imageSrc, altText }) => {
  if (!isOpen) return null;
...
const TemplateResultStep = ({ onRegenerate, loading = false }) => {
  ...
  const { createImageShare, updateImageShare, isCreating: isUpdating } = useMediaShareStore();
