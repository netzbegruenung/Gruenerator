...
const COLLECTION_NAME = 'Frag die Bundestagsfraktion';
...
const SOURCES = [
  { name: 'Bundestagsfraktion', count: '542 Artikel' }
];

const BundestagsfraktionNotebookPage = () => {
  const {
...
export default withAuthRequired(BundestagsfraktionNotebookPage, {
