...
import { HiPlus, HiExclamationCircle, HiRefresh, HiChatAlt2 } from 'react-icons/hi';
...
import { useQACollections, useUserTexts } from '../../hooks/useProfileData';
...
const DocumentsTab = ({ isActive, onSuccessMessage, onErrorMessage }) => {
    ...
    }, [qaError, textsError, documentsError, onErrorMessage]);
    ...
    const availableViews = ['documents', 'texts', ...(isQAEnabled ? ['qa'] : [])];
