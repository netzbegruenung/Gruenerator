...
## Die 13 Themenkategorien

| Thema              | Beschreibung                         |
| ------------------ | ------------------------------------ |
| Migration          | Flucht, Asyl, Einwanderung           |
| Klima & Umwelt     | Klimaschutz, Energie, Nachhaltigkeit |
| Wirtschaft         | Unternehmen, Industrie, Handel       |
| Soziales           | Rente, Familie, Armut                |
| Sicherheit         | Polizei, Verteidigung, Terrorismus   |
| Gesundheit         | Krankenhaus, Pflege, Medizin         |
| Europa/Außen       | EU, Außenpolitik, Ukraine            |
| Digitales & Medien | Internet, Daten, Technologie         |
| Bildung            | Schule, Universität, Forschung       |
| Finanzen           | Steuern, Haushalt, Schulden          |
| Justiz/Recht       | Gerichte, Gesetze, Verfassung        |
| Arbeit             | Lohn, Gewerkschaft, Beschäftigung    |
| Mobilität          | Verkehr, Bahn, Auto, ÖPNV            |
