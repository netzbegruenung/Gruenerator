...
- **„+"-Menü** links im Eingabefeld für Rezepte, Werkzeuge, Quellen und Dateien
...
Du musst dir keine `@`-Namen merken: Öffne das **„+"-Menü** links im Eingabefeld und dann **Funktionen**. Dort stehen alle Werkzeuge aus der Tabelle oben zur Auswahl, und ein Klick setzt die passende `@`-Erwähnung in deine Nachricht.

Die Erwähnung gilt jeweils **für diese eine Nachricht**. Für die nächste wählst du sie erneut aus — dauerhaft eingeschaltet bleibt kein Werkzeug.
:::
