...
- **Mistral AI** (Frankreich) — Standardmodell Mistral Medium 3.5 (`mistral-medium-2604`), Werkzeug-Planung mit Mistral Small, Bildverstehen mit Pixtral Large, Suche und Notebooks mit `mistral-embed`, Transkription mit Voxtral
