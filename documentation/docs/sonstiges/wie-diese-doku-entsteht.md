...
| Chat-Fähigkeiten                                  | Die Liste der Absichten, die der Chat erkennen kann, plus die @-Erwähnungen   | [Was kann ich fragen?](/docs/features/chat/was-kann-ich-fragen)                                                                    |
...
| Dateilimits, Sammlungen, Konnektoren              | Die Upload-Prüfung und die Konnektor-Registry                                 | [Dateien hinzufügen](/docs/features/chat/dateien-hinzufuegen), [Konnektoren](/docs/guides/fortgeschrittene/konnektoren-einrichten) |
