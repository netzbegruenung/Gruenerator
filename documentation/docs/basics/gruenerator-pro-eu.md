...
- **GreenPT** (Paris und Helsinki) — Werkzeug-Planung mit Mistral Small (Ausweichwege: Cortecs, Regolo und Mistral), erzeugte Dateien (PDFs, Präsentationen, Tabellen, Dokumente) mit Gemma 4 sowie der Ausweichweg für die Transkription, 100 % erneuerbare Energie
