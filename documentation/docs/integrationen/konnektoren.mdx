...
Du sprichst sie wie jeden anderen Konnektor per `@`-Mention an — etwa _„Was steht in **@gesetze** zu § 823 BGB?"_. Wenn du einen davon nicht brauchst, kannst du ihn mit dem Schalter **Aktiv** ausschalten; entfernen lassen sie sich nicht, weil es nichts zu trennen gibt.
