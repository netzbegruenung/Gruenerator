...
Über die Suche findest du weitere Server aus dem offenen MCP-Katalog — oder du fügst einen eigenen hinzu. Manche Anbieter verlangen dafür weiterhin eine eigene App-Registrierung pro Organisation, etwa Zoom oder DocuSign.
:::

:::tip[Typeform-Rechenzentrum wählen]
Für die meisten Typeform-Konten wählst du **Typeform**. EU-gehostete Konten brauchen einen der beiden **Typeform (EU …)**-Einträge; die beiden EU-Endpunkte sind nicht austauschbar. Wenn du dein Rechenzentrum nicht kennst, frage den Typeform-Support bzw. deinen Customer Success Manager.
:::
