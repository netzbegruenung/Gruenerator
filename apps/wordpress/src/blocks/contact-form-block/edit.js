    ...
    <div {...blockProps}>
      <InspectorControls>
              ...
              <MediaUpload
                ...
                render={({ open }) => (
                  <div>
                    ...
                    >
                      {backgroundImageUrl
                        ? __('Hintergrundbild ändern', 'gruenerator')
                        : __('Hintergrundbild auswählen', 'gruenerator')}
                    </Button>
                  </div>
                )}
              />
        ...
        <PanelBody title={__('Social Media Profile', 'gruenerator')} initialOpen={false}>
          ...
          <Button variant="primary" onClick={addSocialMediaProfile} style={{ width: '100%' }}>
