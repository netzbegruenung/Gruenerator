...
const deprecated = [
  {
    ...
    save: ({ attributes }) => {
      ...
      return (
        <div {...blockProps}>
          <RichText.Content tagName="h2" className="meine-themen-title" value={title} />
          <div className="meine-themen-grid">
            {themes.map((theme, index) => (
              <div key={index} className="theme-card">
                ...
                <RichText.Content tagName="h3" className="theme-title" value={theme.title} />
                <RichText.Content tagName="p" className="theme-content" value={theme.content} />
              </div>
            ))}
          </div>
        </div>
