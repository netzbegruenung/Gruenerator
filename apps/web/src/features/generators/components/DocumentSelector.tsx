          ...
          <div className="doc-selector__chips">
            ...
            <div className="chips-container">
              ...
              {hiddenChipsCount > 0 && !showAllChips && (
                <button className="chips-more" onClick={() => setShowAllChips(true)}>
                  +{hiddenChipsCount} weitere
                </button>
              )}
              {showAllChips && selectedDocuments.length > 3 && (
                <button className="chips-less" onClick={() => setShowAllChips(false)}>
                  weniger
                </button>
              )}
            </div>
              ...
              filteredDocuments.map((document) => {
                ...
                return (
                  ...
                  >
                    {/* Selection Checkmark */}
                    <div
                      className={`doc-card__check ${isSelected ? 'doc-card__check--visible' : ''}`}
                    >
                      <HiCheckCircle />
                    </div>
