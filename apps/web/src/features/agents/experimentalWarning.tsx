...
export function ExperimentalAgentBanner({ className }: { className?: string }) {
  return (
    <DismissableBanner
      ...
      className={className}
    >
      <strong>Experimentelles Feature</strong> — Eigene Agents sind noch in der Erprobung. Verhalten
      und Funktionen können sich ändern, und nicht alles funktioniert schon zuverlässig. Bitte melde
      Probleme dem Team.
    </DismissableBanner>
  );
}
