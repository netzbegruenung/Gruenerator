...
const NotebookSearchPage = () => {
  ...
  const { Textarea } = useFormFields() as {
  ...
  const metadata = getGeneratedTextMetadata(componentName) as {
    sources?: Source[];
    citations?: Citation[];
  } | null;
  ...
  const helpContent = {
    content:
      'Stellen Sie Fragen zu Ihren hochgeladenen Dokumenten. Das System durchsucht Ihre Dokumente und gibt Ihnen präzise Antworten basierend auf dem Inhalt.',
    tips: [
