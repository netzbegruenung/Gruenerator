...
export const CustomExamplePage = () => {
  return (
    <PageView>
      ...
      <PageContent>
        <p>
          Politik ist kein abstraktes Konzept, sondern wirkt sich direkt auf unser tägliches Leben
          aus. Hier zeigen wir, wie grüne Politik konkret funktioniert und wie jeder von uns einen
        ...
        <p>
          Die grüne Bewegung hat bereits viel erreicht. Von der Energiewende über die Verkehrswende
          bis hin zu neuen Standards in der Landwirtschaft - grüne Ideen werden zu konkreter
          Politik.
        </p>
        ...
        <p>
          Demokratie lebt von der Beteiligung aller. Ob als Mitglied, als Unterstützer oder einfach
          als interessierte Bürgerin - es gibt viele Wege, sich für eine grüne Zukunft einzusetzen.
        </p>

        <InfoBox title="Mitmach-Möglichkeiten" variant="default">
          <p>
            <strong>Mitglied werden:</strong> Gestalte aktiv die Programmatik und Kandidatenauswahl
            mit.
            <br />
            <strong>Ehrenamt:</strong> Engagiere dich in Arbeitskreisen oder bei Veranstaltungen.
            <br />
            <strong>Spenden:</strong> Unterstütze unsere Arbeit finanziell.
            <br />
