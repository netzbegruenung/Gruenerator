...
const CanvaButton = ({
  ...
  const renderIcon = () => (
    <div className="canva-button-icon">
      <img src="/images/canva/Canva Icon logo.svg" alt="Canva" className="canva-logo" />
    </div>
  );
  ...
  const renderContent = () => {
    ...
    return (
      <>
        {renderIcon()}
        <span className="canva-button-text">{children || 'Mit Canva verbinden'}</span>
      </>
    );
  };
