...
/**
 * Experimental-feature notice shown on every surface of the sharepic creation
 * flow. The canvas creator is public but still in active development, so this
 * sets expectations and points people at the team for bug reports. Wording
 * matches the agent creator's ExperimentalAgentBanner.
 */
export function SharepicResearchPreviewBanner({ className }: { className?: string }) {
  return (
    <DismissableBanner
      ...
      className={className}
    >
      <strong>Experimentelles Feature</strong> — Der Sharepic-Creator ist noch in der Erprobung.
