...
const CitationBadge = ({
  ...
  return (
    <span className="relative inline" ref={badgeRef}>
      <button
        type="button"
        className="border-none p-0 inline-flex items-center justify-center size-[18px] bg-accent dark:bg-primary-400 text-background dark:text-grey-950 text-[0.75rem] font-semibold rounded-full cursor-pointer transition-all duration-200 mx-0.5 relative -top-0.5 select-none hover:bg-link hover:scale-105"
