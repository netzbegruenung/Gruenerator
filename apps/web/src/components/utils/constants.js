...
export const IMAGE_MODIFICATION = {
  ...
  COLOR_SCHEMES: [
    {
      ...
      colors: [{ background: '#005538' }, { background: '#F5F1E9' }, { background: '#F5F1E9' }],
      imageSrc: '/images/Tanne_Sand_Sand.png',
    },
    {
      name: 'Sand-Tanne-Tanne',
      colors: [{ background: '#F5F1E9' }, { background: '#005538' }, { background: '#005538' }],
      imageSrc: '/images/Sand_Tanne_Tanne.png',
    },
    {
      name: 'Sand_Tanne_Sand',
      colors: [{ background: '#F5F1E9' }, { background: '#005538' }, { background: '#F5F1E9' }],
      imageSrc: '/images/Sand_Tanne_Sand.png',
    },
    {
      name: 'Sand_Sand_Tanne',
      colors: [{ background: '#F5F1E9' }, { background: '#F5F1E9' }, { background: '#005538' }],
  ...
  LABELS: {
    ...
    TEXT_POSITION_DESCRIPTION:
      'Verschieben Sie die Regler, um die Position der Textbalken anzupassen',
    COLOR_SCHEME: 'Farbschema',
    COLOR_SCHEME_DESCRIPTION:
      'Wählen Sie das Farbschema für Ihr Bild aus, indem Sie auf eines der Bilder klicken.',
    ...
    BALKEN_OFFSET_PRESETS_DESCRIPTION:
      'Wählen Sie eine Voreinstellung für die Position der Textbalken aus.',
    OFFSET_CONTROLS_TITLE: 'Positionssteuerung',
    OFFSET_CONTROLS_DESCRIPTION: 'Passen Sie die Positionen der Elemente auf dem Bild an.',
  },
...
export const FORM_PLACEHOLDERS = {
  ...
  IDEE: 'Worum gehts?',
  DETAILS:
    'Alle wichtigen Details und Anweisungen, zum Beispiel wo etwas gebaut wird. Du kannst hier auch Hinweise zur Sprache oder Korrekturen angeben.',
  ...
  DETAILS_ALL:
    'Durch Baumpflanzaktionen, neue Parks und grüne Dachflächen in Kooperation mit lokalen Schulen und Unternehmen.',
...
export const HEADER_TEXT = {
  ...
  DROPDOWN_ITEMS: {
    ...
    GPTS: [
      {
        LINK: 'https://chat.openai.com/g/g-Xd3HrGped-wahlprufstein-grunerator',
        TEXT: 'Wahlprüfstein',
        ICON: 'PiFile',
      },
      {
        LINK: 'https://chat.openai.com/g/g-ZZwx8kZS3-grunerator-social-media',
        TEXT: 'Social Media',
        ICON: 'PiGlobe',
      },
    ],
...
export const WAHLPROGRAMM_GENERATOR = {
  ...
  CONFIRMATION_MESSAGES: {
    BACK_TO_START:
      'Möchtest du wirklich zurück zum ersten Schritt? Das generierte Wahlprogramm-Kapitel geht verloren.',
  },
  LOG_MESSAGES: {
