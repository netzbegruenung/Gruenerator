...
// Pride month (June, month index 5): tint the Workplace icon with a rainbow
// gradient. Evaluated per render so it switches on/off at the month boundary
// with no code change or manual revert needed.
const isPrideMonth = () => new Date().getMonth() === 5;

const GrueneratorHomeIcon = (props: SVGProps<SVGSVGElement>) => {
...
export default GrueneratorHomeIcon;
