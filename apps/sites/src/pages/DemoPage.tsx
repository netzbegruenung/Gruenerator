...
Mein Antrieb: Eine Welt hinterlassen, in der auch unsere Enkel noch gut leben können. Dafür kämpfe ich - pragmatisch, engagiert und immer mit einem offenen Ohr für die Menschen vor Ort.`,
    ...
    themes: [
      {
        ...
        content: 'Bis 2035 klimaneutral: Mit Solaroffensive, Windkraftausbau und energetischer Gebäudesanierung schaffen wir die Energiewende vor Ort.',
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=600&h=400&fit=crop',
        title: 'Bildung & Chancen',
        content: 'Beste Bildung für alle: Kleinere Klassen, digitale Ausstattung und Chancengleichheit von der Kita bis zur Berufsausbildung.',
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=600&h=400&fit=crop',
        title: 'Mobilität der Zukunft',
        content: 'Bus und Bahn im 15-Minuten-Takt, sichere Radwege und Car-Sharing: Mobilität muss klimafreundlich und bezahlbar sein.',
      },
    ],
  },
  actions: {
    actions: [
      {
        imageUrl: 'https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=400&h=533&fit=crop',
        text: 'Unterstütze uns',
        link: '#spenden',
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&h=533&fit=crop',
        text: 'Werde Mitglied',
        link: 'https://www.gruene.de/mitglied-werden',
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=400&h=533&fit=crop',
        text: 'Mach mit!',
        link: '#kontakt',
      },
    ],
  ...
  contact: {
    ...
    backgroundImageUrl: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1600&h=900&fit=crop',
