 ...
 * and writes one JSON file per LV to documentation/docs/features/landesverbaende/_raw/.
 *
...
const OUTPUT_DIR = path.resolve(process.cwd(), 'documentation/docs/features/landesverbaende/_raw');
