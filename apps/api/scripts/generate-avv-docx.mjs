...
const content = [
  ...
  { li: '**KI-Textgenerierung:** Erstellung von Pressemitteilungen, Social-Media-Beiträgen, Reden und weiteren Texten; das Modell ist pro Anfrage wählbar (Mistral AI/FR, eigene KI-Modelle der netzbegrünung e.V./EU, Seeweb/Regolo AI/IT)' },
  ...
  { p: '**§ 3 Konkretisierung der Einzelmaßnahmen:**' },
  {
    table: {
      ...
      rows: [
        ...
        ['6', 'Physische Sicherheit', 'Nutzung ISO-27001-zertifizierter Rechenzentren der Dienstleister (Hetzner).'],
  ...
  { p: 'Nach § 8 Abs. 1 sind die bereits hinzugezogenen Subunternehmen zu bezeichnen; der Verantwortliche erklärt sich mit deren Beauftragung einverstanden.' },
  {
    table: {
      ...
      rows: [
        ...
        ['Black Forest Labs ([Vertragsentität eintragen])', 'HQ Freiburg im Breisgau (DE); Vertragsentität noch zu bestätigen', 'Bestehend', 'Bildgenerierung (FLUX)', 'Verarbeitung in der EU (EU-API api.eu.bfl.ai bzw. FLUX bei Regolo). Kein Training.'],
      ],
    },
  },
];
