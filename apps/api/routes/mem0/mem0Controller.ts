...
router.get(
  ...
  async (req: AuthRequest<{ userId: string }>, res: Response): Promise<void> => {
    try {
      ...
      log.error('[mem0 GET /user/:userId] Error:', { error: err });
      res
        .status(500)
...
router.post('/add-text', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const err = error as Error;
    log.error('[mem0 POST /add-text] Error:', { error: err });
    res
      .status(500)
...
router.put(
  ...
  async (req: AuthRequest<{ memoryId: string }>, res: Response): Promise<void> => {
    try {
      ...
      const err = error as Error;
      log.error('[mem0 PUT /:memoryId] Error:', { error: err });
      res
        .status(500)
...
router.post('/search', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const err = error as Error;
    log.error('[mem0 POST /search] Error:', { error: err });
...
router.delete(
  ...
  async (req: AuthRequest<{ memoryId: string }>, res: Response): Promise<void> => {
    try {
      ...
      const err = error as Error;
      log.error('[mem0 DELETE /:memoryId] Error:', { error: err });
      res
        .status(500)
...
router.get(
  ...
  async (req: AuthRequest<{ userId: string }>, res: Response): Promise<void> => {
    try {
      ...
      const err = error as Error;
      log.error('[mem0 GET /user/:userId/export] Error:', { error: err });
...
router.delete(
  ...
  async (req: AuthRequest<{ userId: string }>, res: Response): Promise<void> => {
    try {
      ...
      const err = error as Error;
      log.error('[mem0 DELETE /user/:userId/all] Error:', { error: err });
      res.status(500).json({
        success: false,
