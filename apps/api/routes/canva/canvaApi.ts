...
import type { CanvaDesign, CanvaAsset, CanvaUser, UploadJob } from '../../services/api-clients/canvaApiClient.js';
 ...
 * GET /api/canva/test
 */
router.get('/test', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<TestResponse>) => {
  try {
 ...
 * GET /api/canva/user
 */
router.get('/user', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<UserResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.get('/designs', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<DesignsListResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
    const {
      limit = '10',
 ...
 */
router.get('/designs/:designId', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<DesignResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.post('/designs', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<DesignResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.get('/assets', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<AssetsListResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
    const {
      limit = '10',
 ...
 */
router.get('/assets/:assetId', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<AssetResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.post('/assets/upload', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<UploadResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.get('/assets/upload/:jobId', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<UploadResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
 ...
 */
router.post('/create-from-content', ensureAuthenticated, requireCanvaConnection, async (req: Request, res: Response<DesignFromContentResponse>) => {
  try {
    const canvaReq = req as unknown as CanvaRequest;
    const {
      content,
 ...
 */
router.get('/design-types', ensureAuthenticated, requireCanvaConnection, async (_req: Request, res: Response<DesignTypesResponse>) => {
  try {
