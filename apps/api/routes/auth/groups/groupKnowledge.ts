...
router.get('/groups/:groupId/instructions', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
// Add knowledge entry
router.post('/groups/:groupId/knowledge', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId } = req.params;
    const userId = req.user!.id;
...
router.get('/groups/:groupId/knowledge/:knowledgeId', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.put('/groups/:groupId/knowledge/:knowledgeId', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId, knowledgeId } = req.params;
    const userId = req.user!.id;
    const { title, content } = req.body;
...
router.delete('/groups/:groupId/knowledge/:knowledgeId', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId, knowledgeId } = req.params;
    const userId = req.user!.id;
