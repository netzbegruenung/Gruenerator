...
router.post('/groups/:groupId/share', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.delete('/groups/:groupId/share', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId } = req.params;
    const userId = req.user!.id;
...
router.get('/groups/:groupId/content', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId } = req.params;
    const userId = req.user!.id;
...
router.put('/groups/:groupId/content/:contentId/permissions', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.delete('/groups/:groupId/content/:contentId', ensureAuthenticated as any, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const { groupId, contentId } = req.params;
    const userId = req.user!.id;
