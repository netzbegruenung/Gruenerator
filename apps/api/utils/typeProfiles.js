// Type-specific defaults for prompts and sampling (CommonJS)
...
const profiles = {
  ...
  web_search_summary: {
    system: 'Du bist ein Experte für die Zusammenfassung von Websuche-Ergebnissen. Erstelle KURZE (max. 800 Zeichen), präzise Zusammenfassungen auf Deutsch. WICHTIG: Verwende NUR [1], [2], [3] Zitationen - NIEMALS \"Quelle:\" Format. Fokussiere auf die wichtigsten 2-3 Kernaussagen mit Quellenbelegen.',
    model: 'claude-3-5-haiku-latest',
    temperature: 0.2,
    max_tokens: 400
  },
