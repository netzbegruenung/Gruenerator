...
export async function getDocumentFullText(
    ...
    try {
        ...
        console.log(`[DocumentRetrieval] Reconstructed ${fullText.length} chars from ${sortedChunks.length} chunks for document ${documentId}`);
...
export async function getMultipleDocumentsFullText(
    ...
    try {
        ...
        console.log(`[DocumentRetrieval] Bulk retrieving full text for ${documentIds.length} documents`);
        ...
        console.log(`[DocumentRetrieval] Bulk reconstruction complete: ${documents.length} documents, ${errors.length} errors`);
