...
- **Ausdrücklich danach fragen**, und zwar so, dass sowohl die Doku als auch die gemeinte Funktion vorkommen — "Was steht in der Anleitung zu Sharepics?", "Gibt es eine Schritt-für-Schritt-Anleitung für Notizbücher?". Ebenso greift eine Wie-Frage zu einer Grünerator-Funktion: "Wie erstelle ich ein Sharepic?", "Wo finde ich die Agentura?". Nennt eine Frage nur die Doku, ohne die Funktion zu benennen, wird nicht zwingend nachgeschlagen — dann hilft @doku.
