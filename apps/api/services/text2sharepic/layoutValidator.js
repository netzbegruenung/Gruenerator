 ...
 */
function clampValue(value, constraint) {
 ...
 */
function validateParams(params, componentType) {
 ...
 */
function validateZone(zone, templateId) {
  const errors = [];
  const warnings = [];
 ...
 * @returns {object} Validation result with errors, warnings, and corrected layout
 */
...
function validateAIOutput(aiOutput) {
  ...
  return {
    ...
    errors,
    warnings,
    corrected: layoutValidation.valid ? {
