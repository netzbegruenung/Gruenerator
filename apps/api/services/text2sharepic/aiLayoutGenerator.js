 ...
 */
function buildUserMessage(description, options = {}) {
 ...
 */
async function generateLayout(description, aiWorkerPool, req, options = {}) {
 ...
 */
async function generateLayoutWithRetry(description, aiWorkerPool, req, options = {}, maxRetries = 2) {
  let lastError;
 ...
 */
function buildEditPrompt(currentLayout, editRequest) {
 ...
 */
async function editLayout(currentLayout, editRequest, aiWorkerPool, req) {
  const systemPrompt = buildSystemPrompt();
