...
- Markdown-Tabellen ("| Spalte | Spalte |") sind erlaubt und der richtige Weg für eine Gegenüberstellung mit gleichartigen Feldern (Quelle/Datum, Jahr/Wert). Höchstens 4 Spalten, sonst passt sie nicht auf die Folie. Fließende Aussagen bleiben eine Aufzählung
- KEINE Bild-URLs erfinden. Ein "![…](…)" nur mit einer URL, die im Auftrag steht — eine geratene Adresse landet als kaputtes Bild auf der Folie
