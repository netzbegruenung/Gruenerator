...
export class WorkflowService {
  ...
  async createWorkflow(
    ...
    await redisClient.setEx(this.getKey(workflowId), WORKFLOW_TTL, JSON.stringify(workflow));
  ...
  async saveProduction(
    ...
    await redisClient.setEx(this.getKey(workflowId), 300, JSON.stringify(workflow));
  }
