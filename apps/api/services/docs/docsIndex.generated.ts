...
export const DOCS_SECTIONS: readonly DocSection[] = [
  ...
  },
  {
    ...
    "anchor": "#so-gehts",
    "category": "Guides",
    "text": "Voice öffnen. Öffne im Bereich Arbeiten unter Weitere den Eintrag Voice. Direkt erreichbar ist das Werkzeug auch unter /voice. Text einfügen und für das Hören prüfen. Trage in das Textfeld den Text ein, der gesprochen werden soll. Voice liest grundsätzlich das vor, was dort steht. Schreibe deshalb Abkürzungen aus und entferne Links, Fußnoten oder Zeichen, die nicht mitgesprochen werden sollen. Wenn du noch keinen fertigen Text hast, klicke unter dem Textfeld auf „Text mit KI entwerfen“ (auf dem Handy das Funkel-Symbol). Je nach Aufnahmeart fragt der Grünerator nach den nötigen Angaben und setzt anschließend einen Entwurf in das Textfeld. Der Entwurf wird noch nicht vertont: Lies ihn vollständig durch und korrigiere Namen, Telefonnummern, Uhrzeiten und Aussprache. Pausen setzen. Setze den Cursor an die gewünschte Stelle und klicke auf „Pause einfügen“ (auf dem Handy das Pause-Symbol). Im Text erscheint [Pause]; in der fertigen Aufnahme dauert diese Pause eine halbe Sekunde. Für eine längere Pause kannst du die Schaltfläche mehrfach verwenden. Einstellungen prüfen. Unter dem Textfeld steht in einer Zeile, was gerade eingestellt ist, zum Beispiel „Vorlesefassung · Männlich 1 ·…"
  },
  {
    "url": "/docs/guides/einsteigerinnen/text-vertonen",
    "pageTitle": "Wie vertone ich einen Text?",
