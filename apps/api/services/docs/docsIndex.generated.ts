...
export const DOCS_SECTIONS: readonly DocSection[] = [
  ...
  },
  {
    ...
    "category": "Über den Grünerator",
    "text": "Selbstbewertung, kein externer Test. Konkret: axe-core über 13 Seiten der Web-Oberfläche, zuletzt am 2. August 2026. Gemessen wird bisher nur der helle Modus; der dunkle ist ungeprüft. ESLint-Regelsätze (jsx-a11y für das Web, react-native-a11y für die Mobil-App) laufen bei jeder Änderung mit. Komponententests mit axe an den Stellen, an denen ARIA von Hand gesetzt wird. Ein BITV-Test durch eine unabhängige Prüfstelle hat nicht stattgefunden."
  },
  {
    "url": "/docs/ueber-den-gruenerator/gruenerator-pro-eu",
  ...
  },
  {
    ...
    "category": "Über den Grünerator",
    "text": "Die größten kommerziellen KI-Modelle brauchen für jede einzelne Antwort ein Vielfaches der Energie eines kompakten Modells. Der Grünerator setzt deshalb bewusst auf kleine und mittlere Modelle — vom 31-Milliarden-Parameter-Modell Gemma 4 bis zum mittelgroßen Mistral Medium. Das sind die Modelle, die tatsächlich im Einsatz sind: Aufgabe | Modell | Läuft bei | ----------------------------------------- | -------------------------------------------------- | ---------------------------------------------- | Chat & Texte (Standard) | Mistral Medium 3.5 (mistral-medium-2604) | Mistral AI 🇫🇷 | Kreativtexte, Antworten schreiben | Gemma 4 — 31 Mrd. Parameter (gemma4-31b) | Regolo 🇮🇹 (Ausweichweg verdigado 🇩🇪) | Kurze und strukturierte Antworten | Gemma 4 — 26 Mrd. Parameter (gemma-4-26b-a4b-it) | Scaleway 🇫🇷 (Ausweichweg GreenPT 🇪🇺) | Dokumente, Präsentationen, PDFs, Tabellen | Gemma 4 (gemma4) | GreenPT 🇪🇺 | Schnelle Antworten | GPT-OSS 120B (gpt-oss-120b) | verdigado 🇩🇪 / Regolo 🇮🇹 | Anfragen einordnen, Zwischenschritte | Mistral Small 4 (mistral-small-4-119b) | Regolo 🇮🇹 | Werkzeuge planen und aufrufen | Mistral Small (mistral-small-latest) | Mistral AI 🇫🇷 | Bilder…"
  },
  {
    "url": "/docs/ueber-den-gruenerator/nachhaltigkeit",
    "pageTitle": "Wie nachhaltig ist der Grünerator?",
