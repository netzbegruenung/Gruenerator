...
export const DOCS_SECTIONS: readonly DocSection[] = [
  ...
  },
  {
    ...
    "anchor": "",
    "category": "Archiv",
    "text": "Verschickt am 19. Mai 2026 als Signal-Broadcast · Kurzfassung zum Newsletter Mai 2026. --- Die Karte unten zeigt die Nachricht, wie sie in Signal-Gruppen verschickt wurde — in ihr-Form, weil Signal mehrere Leute gleichzeitig erreicht. Mit einem Klick auf „Für Signal kopieren\" landet der Text in der Zwischenablage: Links als reine URL, Genderstern als Doppelpunkt, Fett wird weggelassen (Signal rendert keine Markdown-Sternchen) — wenn du Fett brauchst, einfach im Chat manuell setzen. Das Bild lädst du mit dem zweiten Button herunter und hängst es in Signal an. Hallo zusammen, ab sofort könnt ihr im Grünerator eure eigenen Notebooks erstellen – mit eigenen Quellen, eigenen Fragen, eigenen Antworten. Ein Notebook ist euer persönliches Archiv: Ihr werft Dokumente rein, und der Grünerator beantwortet eure Fragen ausschließlich auf Basis dieser Dokumente – mit nachprüfbaren Quellenangaben. Offen gesagt: Ich glaube, Notebooks können die Art und Weise, wie wir Parteiarbeit machen, für immer verändern. Wissen wird durchsuchbar wie nie. Damit das Feature für die Basis kostenfrei bleibt, können sich Landesverbände (in Österreich der Bundesverband) spezielle Notebooks mit über 1.000 Dokumenten einkaufen, die sich automatisiert aus öffentlichen Beschlüssen und Pressemitteilungen speisen. Um ein Notebook zu erstellen: gruenerator.eu/notebooks, rechts bei „Eigene\" auf das Plus-Icon. Außerdem neu im Mai-Update: Neuer Dokumenten-Chat. Jedes Grünerator-Dokument hat jetzt einen eigenen Chat. Mit dem Toggle „AN\" schreibt die KI direkt ins Dokument, ihr behaltet die Kontrolle. Tippt „/\" im Editor und wählt „KI\" zum Weiterschreiben. Diktieren geht auch. Neue Agents. Im Chat gibt es neue Spezialist*innen für Öffentlichkeitsarbeit und Kommunalpolitik, dazu einen „Tweet-wie-Ricarda\"-Agent (nur DE). Mit @wolke hängt ihr Dateien aus der Grünen Wolke an, mit @recherche startet ihr tiefe Websuchen. Außerdem ein neues, sehr gutes Mistral-Modell aus Frankreich. Bilder erstellen und bearbeiten. Auf der Startseite und direkt aus dem Chat, unter anderem mit Flux Max für noch bessere Ergebnisse. Der Grünerator befindet sich derzeit in besonders aktiver Entwicklung – es können zwischendurch Fehler auftreten. Dabei zählt jede Rückmeldung. Schreibt mir bitte, wenn etwas hakt. Viel Spaß beim Grünerieren! Moritz Die ausführliche Fassung mit Hintergründen zu Landesverband-Notebooks, Diktier-Tipps und der Robert-Parenthese steht im Newsletter Mai 2026."
  },
  {
    "url": "/docs/bildnachweise",
  ...
  },
  {
    ...
    "category": "Chat",
    "text": "Der Chat kann gezielt in grünen Parteiprogrammen, Beschlüssen und Dokumenten recherchieren. Tippe @ im Eingabefeld, um eine Quelle auszuwählen. @alle Alle Quellen — Durchsucht mehrere Quellen parallel @grundsatz Grundsatzprogramm — Grundsatzprogramme von Bündnis 90/Die Grünen @bundestagsfraktion Bundestagsfraktion — Inhalte von gruene-bundestag.de @at Grüne Österreich — Programme von Die Grünen Österreich @thüringen Grüne Thüringen — Beschlüsse und Wahlprogramme Thüringen @kommunalwiki KommunalWiki — Fachwissen zur Kommunalpolitik @berlin Grüne Berlin — Wahlprogramm 2026, Pressemitteilungen, Beschlüsse und Wahlprüfsteine Berlin @gruenblog Grünblog — Onlinemagazin der Grünen @transparenz Abgeordnetenwatch — Abstimmungen & Nebentätigkeiten von Abgeordneten @mv Grüne Mecklenburg-Vorpommern — Presse und Parteitagsbeschlüsse MV @brandenburg Grüne Brandenburg — Presse, Beschlüsse und Landtagswahlprogramm 2024 Brandenburg @bayern Grüne Bayern — Pressemitteilungen, Beschlüsse und Regierungsprogramm Bayern @sachsen-anhalt Grüne Sachsen-Anhalt — Presse, Beschlüsse und Landtagswahlprogramm 2026 Sachsen-Anhalt @hessen Grüne Hessen — Presse und Beschlüsse Hessen @saar Grüne Saarland — Presse, Artikel und Parteitagsbeschlüsse Saarland Weitere Landesverbände werden laufend ergänzt. Wenn dein Landesverband ein Grünerator Notebook erworben hat, erscheinen eure Daten automatisch als Quelle. Deine @-Mentions erscheinen als Chips in der gesendeten Nachricht und der Chat merkt sie sich: Folgefragen wie „fasse das kürzer\" bleiben automatisch bei der gewählten Quelle bzw. dem gewählten Werkzeug."
  },
  {
    "url": "/docs/chat/ki-chat",
    "pageTitle": "KI-Chat",
  ...
  },
  {
    ...
    "category": "Chat",
    "text": "Rezepte sind spezialisierte Schreib-Modi, die auf bestimmte Textarten optimiert sind — sie kennen den richtigen Ton, die Struktur und die Längenvorgaben der jeweiligen Plattform. So wählst du ein Rezept: Tippe / im Eingabefeld und wähle aus der Liste, oder öffne das „+\"-Menü im Eingabefeld — dort findest du auch die Rezept-Bibliothek mit allen Rezepten /presse Pressemitteilung — Pressemitteilungen verfassen /instagram Instagram — Instagram-Posts & Captions /facebook Facebook — Facebook-Posts & Beiträge /twitter Twitter / X — Tweets & Threads /linkedin LinkedIn — LinkedIn-Posts & Artikel /reel Reel / TikTok — Reel- & TikTok-Skripte /aktion Aktionsideen — Kreative Aktionsideen entwickeln /wahlpruefstein Wahlprüfsteine — Fragenkataloge von Verbänden beantworten /buergermail Bürgerinnen-Mail — Antwort-E-Mail auf eine Bürgerinnenanfrage /presse-berlin PM Berlin — Pressemitteilung im Stil Grüne Berlin /insta-berlin Insta Berlin — Instagram-Post im Stil Grüne Berlin /presse-mv PM MV — Pressemitteilung im Stil Grüne Mecklenburg-Vorpommern /insta-mv Insta MV — Instagram-Post im Stil Grüne Mecklenburg-Vorpommern /presse-thueringen PM Thüringen — Pressemitteilung im Stil Bündnisgrüne Thüringen /insta-thueringen Insta Thüringen — Instagram-Post im Stil Bündnisgrüne Thüringen /presse-brandenburg PM Brandenburg — Pressemitteilung im Stil Brandenburger Bündnisgrüne /insta-brandenburg Insta Brandenburg — Instagram-Post im Stil Brandenburger Bündnisgrüne /presse-bayern PM Bayern — Pressemitteilung im Stil Grüne Bayern /presse-hessen PM Hessen — Pressemitteilung im Stil Grüne Hessen /presse-sachsen-anhalt PM Sachsen-Anhalt — Pressemitteilung im Stil Grüne Sachsen-Anhalt /presse-at Aussendung (AT) — Aussendung im Stil der Grünen Österreich Für Anträge, Reden, Wahlprogramme und Bürger*innenanfragen gibt es eigene Grüneratoren — du findest sie unter dem Menüpunkt in der Seitenleiste und kannst sie direkt im Chat öffnen. Du kannst ein Rezept mit Quellen und Werkzeugen kombinieren. Zum Beispiel: /presse @grundsatz Klimaschutz in Kommunen schreibt eine Pressemitteilung auf Basis des Grundsatzprogramms."
  },
  {
    "url": "/docs/chat/ki-chat",
    "pageTitle": "KI-Chat",
  ...
  },
  {
    ...
    "category": "Chat",
    "text": "Werkzeuge erweitern die Fähigkeiten des Chats über die reine Textgenerierung hinaus. Du kannst sie per @-Mention im Eingabefeld aktivieren — von der Recherche über Bildgenerierung bis zum Erstellen von Dokumenten, Tabellen und Präsentationen. @abgeordnetenwatch Abgeordnetenwatch — Abstimmungen & Nebentätigkeiten von Abgeordneten @board-erstellen Board erstellen — Erstellt ein Board aus dem Chatverlauf @bundestag Bundestag — Drucksachen, Reden & Gesetzgebung aus dem Bundestag @canva Canva — Eigene Canva-Designs einfügen @diagramm Diagramm — Zahlen als Diagramm darstellen @verlauf Chatverlauf — Frühere Chats nach Inhalten durchsuchen @rechnen Rechnen — Berechnungen und Datenauswertung mit Python @connect Verbundene Accounts — Dateien aus verbundenen Diensten einfügen @deepresearch Tiefenrecherche — Gründliche Recherche mit Quellen — als Bericht, wenige pro Tag @docs Dokument einfügen — Dokumente, Dateien & Notizbuch-Inhalte als Kontext hinzufügen @dokument-erstellen Dokument erstellen — Erstellt ein Dokument aus dem Chatverlauf @beispiele Beispiele — Echte Social-Media-Posts als Vorlage und Inspiration @doku Hilfe & Anleitungen — Anleitungen zum Grünerator aus der Doku @bildgenerieren Bildgenerierung — Bild mit KI generieren (Flux) @stadtbegruenen Stadt begrünen — Stadtbild mit Grün transformieren @bildbearbeiten Bild bearbeiten — Angehängtes Bild frei bearbeiten (z.B. \"jünger machen\", \"mehr Grün\") @pdf-erstellen PDF erstellen — Erstellt ein barrierefreies PDF (PDF/UA-1) — Dokument, Brief mit Briefkopf oder ausfüllbares Formular @praesentation-erstellen Präsentation erstellen — Erstellt eine Präsentation (Foliensatz) aus dem Chatverlauf @pressemitteilungen Pressemitteilungen — Echte PMs der Landesverbände als Vorlage @recherche Recherche — Web & Quellen – automatische Suchtiefe @dokumente Dokumente — Parteiprogramme & Beschlüsse durchsuchen @sharepic Sharepic — Sharepic-Varianten erstellen und per Chat bearbeiten (Text, Bild, Farben, Position) @tabelle-erstellen Tabelle erstellen — Erstellt eine Tabelle (Spreadsheet) aus dem Chatverlauf @social Social Post — Post-Text mit passendem Sharepic in einem Zug @zusammenfassung Zusammenfassung — Dokument(e) zusammenfassen @umfragen Umfragen — Meinungsumfragen & Sonntagsfrage durchsuchen @vorlagen Vorlagen — Passende Vorlagen per Vektorsuche einfügen @link Link — Inhalt einer Webseite per URL anhängen @wolke Wolke — Eigene Wolke-Dateien einfügen Was du mit jeder dieser Fähigkeiten konkret fragen kannst, zeigt dir die Seite Was kann ich fragen? mit Musterfragen zu jeder Funktion. Du musst dir keine @-Namen merken:…"
  },
  {
    "url": "/docs/chat/ki-modelle",
  ...
  },
  {
    ...
    "category": "Grüneratoren",
    "text": "Der Editor zeigt links das Formular und rechts eine Live-Vorschau. Die Felder sind in Tabs gegliedert: Grundlagen, Werkzeuge und Wissen (bei wiederkehrenden Aufgaben zusätzlich Zeitplan). Pflichtfelder (Tab Grundlagen): Name — der Anzeigename deines Agenten. Daneben wählst du über den Icon-Picker ein Symbol. Beschreibung — ein kurzer Satz, was der Agent macht. Anleitung — die eigentliche Anweisung an die KI (das „System-Prompt\"), z.B. beginnend mit „Du bist ein*e …\". Mindestens 10 Zeichen. Tab Werkzeuge — wähle per Checkbox, was dein Agent können soll. Standardmäßig sind Grünerator-Wissen und Recherche aktiv. Zur Auswahl stehen: Werkzeug | Funktion | -------------------------- | ---------------------------------------------------------------------------------------------------------------- | Grünerator-Wissen | Durchsucht die Grünerator-Wissensdatenbank (Programme, Beschlüsse, Kommunalwiki). | Recherche | Sucht im Web — die Suchtiefe (schnelle Suche bis mehrstufige Recherche) passt sich automatisch an. | Social-Media-Beispiele | Findet passende Beispiel-Posts aus dem Grünerator-Fundus. | Bildgenerierung | Erstellt Bilder aus einer Beschreibung. | Bildbearbeitung | Bearbeitet ein vorhandenes Bild nach Anweisung. | Bildanalyse | Beschreibt und analysiert hochgeladene Bilder. | Webseiten lesen | Liest den Inhalt einer angegebenen URL aus. | Umfragen | Ruft aktuelle Umfragewerte ab. | Frühere Chats | Durchsucht deine früheren Unterhaltungen. | Eigene Inhalte | Durchsucht die eigenen gespeicherten Texte und Dokumente. | Formulare ausfüllen | Liest die Felder eines angehängten PDF-Formulars und füllt sie aus; die fertige Datei steht zum Download bereit. | Darunter im selben Tab: Quell-Links direkt im Antworttext — für versandfertige E-Mails/Briefe: konkrete Artikel-URLs aus der Recherche erscheinen inline im Text statt nur als Quellen-Karten. Tab Wissen — wähle per Checkbox die Notebooks, die dein Grünerator automatisch als Wissensquelle durchsucht. Mehrfachauswahl ist möglich; zur Auswahl stehen die Abschnitte Grünerator-Notebooks und – sobald du eigene Notebooks hast – Meine Notebooks. Aufklappbare Bereiche (optional): Begrüßung & Startfragen — ein Begrüßungstext und Beispielfragen (eine pro Zeile), die beim Öffnen des Agenten angezeigt werden. Erweiterte Einstellungen — Region (Deutschland de-DE / Österreich de-AT), Tags (kommagetrennt) und das Modell. Lege dir vorher unter Notebooks ein eigenes Notebook an und lade eure Dokumente hoch. Im Editor kannst du es dann unter Wissen → Meine Notebooks auswählen — und dein Agent antwortet ausschließlich aus euren…"
  },
  {
    "url": "/docs/grueneratoren/eigene-agentinnen-erstellen",
    "pageTitle": "Eigene Grüneratoren erstellen",
  ...
  },
  {
    ...
    "category": "Grundlagen",
    "text": "#### Manipulative KI-Systeme Verboten sind KI-Systeme, die menschliches Verhalten durch unterschwellige Beeinflussung oder die Ausnutzung von Schwachstellen einer Person oder Gruppe (z.B. Alter, Behinderung, soziale/wirtschaftliche Situation) erheblich nachteilig beeinflussen und dadurch physischen, psychischen oder finanziellen Schaden verursachen können. Im politischen Kontext könnte dies beispielsweise ein KI-System sein, das Wähler manipuliert, indem es auf nicht wahrnehmbare Weise Emotionen oder Vorurteile anspricht. #### Soziale Bewertung (Social Scoring) KI-Systeme, die Menschen oder Gruppen über einen bestimmten Zeitraum anhand ihres sozialen Verhaltens oder ihrer persönlichen Merkmale bewerten oder klassifizieren und dies zu Diskriminierung oder Ausgrenzung führt, sind verboten. Ein kommunalpolitisches Beispiel wäre ein System, das Bürger nach ihrem Engagement in der Gemeinde bewertet und dies dann für den Zugang zu öffentlichen Dienstleistungen verwendet. #### Echtzeit-Biometrische Fernidentifizierung Diese Praxis ist grundsätzlich verboten, da sie massiv in die Privatsphäre eingreift und ein Gefühl ständiger Überwachung erzeugen kann. Es gibt nur eng definierte und streng begrenzte Ausnahmen, beispielsweise für die Suche nach Opfern von Straftaten, zur Abwehr von Terroranschlägen oder zur Identifizierung von Tätern bei besonders schweren Verbrechen. Diese Ausnahmen erfordern eine vorherige Genehmigung durch eine Justiz- oder Verwaltungsbehörde und sind zeitlich, geografisch und personenbezogen beschränkt. #### Risikobewertung von Straftaten basierend auf Profiling KI-Systeme, die das Risiko einer Person, eine Straftat zu begehen oder erneut zu begehen, ausschließlich auf Basis ihres Profilings oder persönlicher Eigenschaften vorhersagen, sind verboten. Eine KI-gestützte Vorhersage, dass ein Bürger aufgrund seiner sozioökonomischen Daten wahrscheinlich kriminell wird, wäre ein solches verbotenes System. #### Weitere verbotene Praktiken Ungezieltes Auslesen von Gesichtsbildern zur Datenbankerstellung: Das Erstellen oder Erweitern von Gesichtserkennungsdatenbanken durch das ungezielte Auslesen von Gesichtsbildern aus dem Internet oder von Videoüberwachungsaufnahmen ist untersagt. Emotionserkennung am Arbeitsplatz und in Bildungseinrichtungen: Der Einsatz von KI-Systemen zur Ableitung von Emotionen von Personen in diesen Kontexten ist verboten, es sei denn, es dient medizinischen oder Sicherheitszwecken. Biometrische Kategorisierung sensibler Attribute: Das Kategorisieren von Personen anhand biometrischer Daten zur Ableitung von Rasse,…"
  },
  {
    "url": "/docs/grundlagen/risiken-und-gefahren-von-llms",
    "pageTitle": "Risiken und Gefahren",
