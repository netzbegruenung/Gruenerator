...
-- 2026-12-18); the live binding is default_recipe_mention/default_recipe_id,
-- and column drops aren't allowed. The recipe an agent auto-loads at chat
-- time is bound here instead:
