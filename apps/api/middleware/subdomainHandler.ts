...
import { SubdomainRequest, UserSiteData } from './types.js';
 ...
 */
export const subdomainHandler = async (req: SubdomainRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
