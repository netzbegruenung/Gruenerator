  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={cn(
            'absolute top-full z-50 mt-1 overflow-hidden rounded-xl border border-secondary-200 bg-background shadow-lg dark:border-secondary-700 dark:bg-secondary-900',
            width,
