...
**Wo eine URL erst absolutiert wird (Notizbücher), wird der ROHE gespeicherte Wert gehasht** — `absolutizeUrl` hängt `APP_BASE_URL` an, und dasselbe Dokument bekäme sonst auf Test und Prod verschiedene refs.
