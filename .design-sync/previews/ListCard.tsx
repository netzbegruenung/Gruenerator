  ...
  return (
    <ListCard interactive={false} style={{ maxWidth: 520 }}>
      ...
      <ListCardContent>
        ...
        <ListCardDescription>
          Wöchentliche kritische Analyse der INSM-Veröffentlichungen mit Vergleich zu grünen
          Positionen.
        </ListCardDescription>
        <ListCardMeta>
  ...
  return (
    <ListCard interactive={false} style={{ maxWidth: 520 }}>
      ...
      <ListCardContent>
        ...
        <ListCardDescription>
          Tägliche Zusammenfassung aller Artikel über Die Grünen in den zehn größten deutschen
          Zeitungen.
        </ListCardDescription>
        <ListCardMeta>
