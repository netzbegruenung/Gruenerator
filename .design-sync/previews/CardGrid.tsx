...
const TILES = [
  { Icon: Megaphone, label: 'Pressemitteilung', desc: 'Erstelle druckreife Statements zu aktuellen Themen.', badge: 'Beliebt' },
  ...
  { Icon: Calendar, label: 'Veranstaltung', desc: 'Plane Termine und schreibe passende Einladungen.', badge: 'Neu' },
];
        ...
        <Card key={label} style={{ height: '100%' }}>
          <CardHeader>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
              <span style={{ color: 'var(--secondary-600, #5F8575)' }}><Icon /></span>
