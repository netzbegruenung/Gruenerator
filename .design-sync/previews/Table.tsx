...
export function AntraegeTable() {
  const rows = [
    {
      id: 'A-2026-014',
      titel: 'Kommunaler Wärmeplan beschließen',
      gremium: 'Ortsverband Mitte',
      status: 'Veröffentlicht',
      variant: 'default' as const,
    },
    {
      id: 'A-2026-017',
      titel: 'Radwegenetz Innenstadt ausbauen',
      gremium: 'Fraktion',
      status: 'In Prüfung',
    ...
    {
      id: 'A-2026-021',
      titel: 'Förderung für Dachbegrünung',
      gremium: 'AG Klima',
      status: 'Entwurf',
  ...
  return (
    <Table>
      ...
      <TableBody>
        {rows.map((r) => (
          <TableRow key={r.id}>
            <TableCell style={{ fontVariantNumeric: 'tabular-nums', opacity: 0.75 }}>
              {r.id}
            </TableCell>
