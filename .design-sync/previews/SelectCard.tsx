  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 360 }}>
      <SelectCard
        ...
        icon={<IconCircle bg="#52907A"><LeafIcon /></IconCircle>}
        selected
        onClick={() => {}}
      />
      <SelectCard
        ...
        description="Themenschwerpunkt für deine Kampagne"
        icon={<IconCircle bg="#5F8575"><MegaphoneIcon /></IconCircle>}
        onClick={() => {}}
      />
    </div>
  );
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, maxWidth: 560 }}>
      <SelectCard
        ...
        icon={<IconCircle bg="#52907A"><MegaphoneIcon /></IconCircle>}
        selected
        onClick={() => {}}
      />
      <SelectCard
        ...
        icon={<IconCircle bg="#7c3aed"><UsersIcon /></IconCircle>}
        onClick={() => {}}
      />
    </div>
  );
