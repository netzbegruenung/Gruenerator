    ...
    <div style={{ maxWidth: 480 }}>
      <Accordion type="single" collapsible defaultValue="datenschutz">
        <AccordionItem value="datenschutz">
          ...
          <AccordionContent>
            Alle Inhalte werden ausschließlich auf EU-Servern gehostet. Deine Entwürfe sind privat
        ...
        <AccordionItem value="export">
          ...
          <AccordionContent>
            Ja. Jede Pressemitteilung und jeder Antrag lässt sich als PDF, ODT oder formatierter
            Text herunterladen – direkt aus dem Editor.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="team">
          <AccordionTrigger>Wie lade ich mein Team ein?</AccordionTrigger>
          <AccordionContent>
            Über die Mitgliederverwaltung kannst du Kolleg:innen aus deinem Kreis- oder
            Landesverband per E-Mail einladen und Rollen zuweisen.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
