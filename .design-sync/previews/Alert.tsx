  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 460 }}>
      <Alert>
        ...
        <AlertDescription>
          Deine Änderungen am Antrag wurden um 14:32 Uhr gesichert. Du kannst jederzeit zur letzten
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Die Pressemitteilung konnte nicht an den Presseverteiler gesendet werden. Bitte prüfe die
