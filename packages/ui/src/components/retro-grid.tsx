...
export function RetroGrid({
  ...
  return (
    ...
    >
      ...
      {!isWebGlReady ? (
        <div className="absolute inset-0" style={fallbackProjectionStyles}>
          <div className="absolute inset-0" style={fallbackRotationStyles}>
            <div
              data-retro-grid-scroll="true"
              className="absolute inset-[0%_0px] ml-[-200%] h-[300vh] w-[600vw] origin-[100%_0_0] [html[data-theme=dark]_&]:hidden"
              style={lightFallbackGridStyles}
            />
            <div
              data-retro-grid-scroll="true"
              className="absolute inset-[0%_0px] ml-[-200%] hidden h-[300vh] w-[600vw] origin-[100%_0_0] [html[data-theme=dark]_&]:block"
      ...
      />
      <div className="absolute inset-0 bg-linear-to-t from-white to-transparent to-90% [html[data-theme=dark]_&]:from-black" />
    </div>
  );
}
