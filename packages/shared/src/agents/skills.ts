...
export const SKILLS = [
  ...
  // ─── Per-Landesverband shortcuts (Berlin / Hamburg / MV / Thüringen / Brandenburg) ───
  // Thin UX wrappers around the per-LV agents. promptTemplate stays short —
  // the LV style is carried by the agent's systemRole, not by the visible
  // composer template. Selecting one of these picks the LV-tuned agent AND
  // pre-fills the topic opener.
  {
