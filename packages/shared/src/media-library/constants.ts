...
/**
 * Internal artifacts that only back another element's image URL, never a
 * standalone library entry: canvas/template gallery thumbnails, plus
 ...
 * element is the user-facing representation.
 */
