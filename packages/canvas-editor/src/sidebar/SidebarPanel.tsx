    ...
    <>
      ...
      <div
        className={cn(
          ...
          'canvas-mobile:top-0 canvas-mobile:bottom-0 canvas-mobile:right-auto canvas-mobile:w-auto canvas-mobile:min-w-[120px] canvas-mobile:max-w-[320px] canvas-mobile:rounded-br-xl canvas-mobile:shadow-[8px_0_24px_rgba(0,0,0,0.1)] canvas-mobile:pt-12',
