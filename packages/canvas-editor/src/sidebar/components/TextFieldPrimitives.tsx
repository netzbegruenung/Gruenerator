...
export function FontSizeStepper({ value, onChange, min = 12, max = 200 }: FontSizeStepperProps) {
...
// ============================================================================
// TEXT FIELD (label + input/textarea + optional font size stepper)
// ============================================================================
...
export function TextField({ config, value, onChange, fontSize, onFontSizeChange }: TextFieldProps) {
