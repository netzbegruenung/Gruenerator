 ...
 * frueher ein volles `resetStore()` und damit ein Datenverlust: `config`
 * gehoert bei anliegender Yjs-Bindung dem gemeinsamen Dokument, und der
 * Anfangswert reiste in die Y.Doc jedes Mitarbeitenden (#3413).
