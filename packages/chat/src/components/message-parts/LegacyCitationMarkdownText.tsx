...
/**
 * Legacy react-markdown renderer, kept byte-for-byte as the rollback branch
 * behind `isStreamdownRendererEnabled()` (streamdownRenderer.ts). Delete once
 * the Streamdown path is the validated default.
 */
function LegacyCitationMarkdownTextImpl() {
...
export const LegacyCitationMarkdownText = memo(LegacyCitationMarkdownTextImpl);
