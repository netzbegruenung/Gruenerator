    ...
    <>
      ...
      >
        ...
        <div className=" flex items-center justify-center px-[115px]">
          <div
            className="w-full h-full bg-[#EBEBEB] rounded-[4.7px] border-[1.3px] border-[#F0F0F2] flex flex-col items-center justify-center p-5"
            style={{
          ...
          >
                ...
                {graph?.rows?.map((entry, index) => (
                  <div key={`legend-${index}`} className="flex items-center gap-2">
                    <div
                      ...
                      style={{
                        backgroundColor: `var(--graph-${index}, ${COLORS[index % COLORS.length]})`,
                      }}
                    />
                    <span
                      style={{
            ...
            {/* Chart Container */}
            <div className="max-w-[1050px] mx-auto w-full h-full ">{renderChart()}</div>
          </div>
        </div>
