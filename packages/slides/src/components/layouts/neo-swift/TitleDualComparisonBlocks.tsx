            ...
            <div key={idx} className="flex flex-col flex-1 max-w-[531.5px]">
              ...
              <div className="ml-0 mb-[12px]">
                <div
                  ...
                  style={{
                    backgroundColor:
                      idx === 0 ? 'var(--primary-color,#BEF4FE)' : 'var(--card-color,#FFFFFF)',
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    idx === 1 ? 'var(--primary-color,#BEF4FE)' : 'var(--card-color,#FFFFFF)',
                  borderColor: 'var(--stroke,#EBEBEB)',
                }}
              >
                <h2
                  ...
                  style={{
                    color:
                      idx === 1 ? 'var(--primary-text,#000000)' : 'var(--background-text,#000000)',
                  }}
                >
                  {block?.heading}
                </h2>
