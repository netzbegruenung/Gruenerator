...
const MultiChartGridWithMetricsSlideLayout: React.FC<MultiChartGridWithMetricsSlideLayoutProps> = ({
  data: slideData,
}) => {
    ...
    <>
      ...
      >
        ...
        <div className="relative h-full px-10 pt-10 pb-8 flex flex-col z-10">
          ...
          {/* Charts Grid */}
          <div
            className={`flex-1 grid ${gridLayout.className} gap-4`}
            style={{ height: hasMetrics ? '450px' : '525px' }}
          >
