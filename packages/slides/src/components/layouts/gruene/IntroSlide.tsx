import { type IntroData } from './IntroSlide.schema.js';

export { Schema, layoutId, layoutName, layoutDescription } from './IntroSlide.schema.js';
...
const IntroSlide = ({ data }: { data: Partial<IntroData> }) => {
