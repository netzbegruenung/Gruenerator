...
import { Schema, SeriesSchema, type ChartData } from './ChartSlide.schema.js';

export { Schema, layoutId, layoutName, layoutDescription } from './ChartSlide.schema.js';
...
const ChartSlide = ({ data }: { data: Partial<ChartData> }) => {
  return (
    <>
