import { type TextImageLeftData } from './TextImageLeftSlide.schema.js';

export { Schema, layoutId, layoutName, layoutDescription } from './TextImageLeftSlide.schema.js';
...
const TextImageLeftSlide = ({ data }: { data: Partial<TextImageLeftData> }) => {
  return (
    <>
      ...
      >
        ...
        <div className="w-[480px] h-full shrink-0 relative">
          ...
          {data.accentBadge && (
            <div
              className="absolute -right-8 bottom-16 w-[140px] h-[100px] flex items-center justify-center rounded-[50%] z-20"
              style={{
...
export default TextImageLeftSlide;
