import { type TextImageRightData } from './TextImageRightSlide.schema.js';

export { Schema, layoutId, layoutName, layoutDescription } from './TextImageRightSlide.schema.js';
...
const TextImageRightSlide = ({ data }: { data: Partial<TextImageRightData> }) => {
  return (
    <>
