import { type BrandedMessageData } from './BrandedMessageSlide.schema.js';

export { Schema, layoutId, layoutName, layoutDescription } from './BrandedMessageSlide.schema.js';
...
const BrandedMessageSlide = ({ data }: { data: Partial<BrandedMessageData> }) => {
  return (
    <>
