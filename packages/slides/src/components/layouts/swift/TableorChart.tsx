...
const Schema = z
  .object({
    ...
    description: z
      ...
      .min(20)
      .max(220)
      .default('Present structured information in a flexible table or visualize it with a chart.'),
  ...
  .default({
    ...
    description: 'Present structured information in a flexible table or visualize it with a chart.',
    mode: 'table',
    ...
    <>
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1">
              ...
              {(slideData as any)?.__companyName__ && (
                <span className="text-[16px]" style={{ color: 'var(--background-text, #6B7280)' }}>
                  {(slideData as any)?.__companyName__}
                </span>
              )}
            </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                {type === 'bar' ? (
                  <BarChart data={cData} margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
                    ...
                    <XAxis
                      dataKey="label"
                      tick={{ fill: 'var(--background-text, #6B7280)', fontWeight: 600 }}
                    />
                    <YAxis tick={{ fill: 'var(--background-text, #6B7280)', fontWeight: 600 }} />
                    <Tooltip
                      labelStyle={{ color: 'var(--background-text, #6B7280)' }}
                      itemStyle={{ color: 'var(--background-text, #6B7280)' }}
                    />
                    ...
                    <Bar
                      ...
                      label={
                        showLabels
                          ? {
                              position: 'top',
                              fill: 'var(--background-text, #111827)',
                              fontSize: 12,
                            }
                          : false
                      }
                  ...
                  <PieChart>
                    ...
                    <Pie
                      ...
                      cy="50%"
                      outerRadius={120}
                      label={showLabels ? { fill: 'var(--background-text, #6B7280)' } : false}
                    >
                      {cData.map((_, i) => (
                        <Cell key={i} fill={CHART_COLORS[i % CHART_COLORS.length]} />
                      ))}
        ...
        <div className="absolute bottom-8 left-12 right-12 flex items-center">
          <span className="text-[14px]" style={{ color: 'var(--background-text, #6B7280)' }}>
            {slideData?.website}
          </span>
          <div
