        ...
        .array(
          z.object({
            ...
            value2: z
              .number()
              .optional()
              .describe('The value for the second series (optional for single-series charts)'),
          })
        )
        .max(4)
            ...
            >
              ...
              >
                <LabelList
                  ...
                  style={{ fontSize: '14px', fontWeight: 'bold', fontFamily: 'Montserrat Bold' }}
                />
              </Bar>
              {hasValue2 && (
                <Bar
      ...
      >
        <div className="flex flex-col h-full w-full py-0">
          ...
          >
            ...
            {/* Graph Section */}
            <div className="px-[65px] py-6">{renderChart()}</div>
