        ...
        .array(
          z.object({
            ...
            value2: z
              .number()
              .optional()
              .describe('The second series value (optional for single-series charts)'),
          })
        )
        .max(4)
          ...
          <ResponsiveContainer width="100%" height={350}>
            ...
            >
              ...
              <Legend
                ...
                align="right"
                iconType="circle"
                wrapperStyle={{ paddingBottom: '20px', fontSize: '12px', color: '#6B7280' }}
                formatter={(value, entry, index) => chartData?.columns?.[index] || value}
              />
              <Bar
                dataKey="value1"
                stackId="a"
                ...
                label={{ position: 'inside', fill: 'var(--primary-text, #fff)', fontSize: 12 }}
              />
              {hasValue2 && (
                <Bar
                  dataKey="value2"
      ...
      >
        <div className="flex w-full h-full p-[60px] gap-[40px]">
          ...
          <div className="flex flex-col basis-[55%] h-full justify-center">
            ...
            <div
              className="flex-grow border rounded-[6px] p-[20px] relative"
              style={{
                backgroundColor: 'var(--card-color,#FFFFFF)',
            ...
            >
              ...
              <div
                className="absolute bottom-[-15px] right-[20px] text-[16px] font-normal italic opacity-80"
                style={{ color: 'var(--background-text,#244CD9)' }}
              >
                {chartFooterLabel}
              </div>
