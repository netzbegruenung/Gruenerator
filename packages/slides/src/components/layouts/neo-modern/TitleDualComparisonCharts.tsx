            ...
            <LineChart data={chartData} margin={{ top: 40, right: 10, left: -20, bottom: 20 }}>
              ...
              <Legend
                ...
                formatter={(value, entry: any) => {
                  if (entry.dataKey === 'series1') return chartData[0]?.series1Name;
                  if (entry.dataKey === 'series2') return chartData[0]?.series2Name;
                  return value;
                }}
              />
              <Line
          ...
          {comparisonCards?.map((card, idx) => {
            return (
              ...
              >
                ...
                {/* Chart Container */}
                <div className=" w-full min-h-0">{renderChart(card)}</div>
