...
export const layoutDescription = 'A bullet with icons description grid slide layout';
...
const bulletWithIconsDescriptionGridSlideSchema = z.object({
  ...
  sections: z
    ...
    .meta({
      description: 'List of solution sections with titles, descriptions, and optional icons',
    }),
});
