    ...
    .default([
      ...
      },
      {
        ...
        image: {
          ...
          __image_prompt__: 'Woman working at computer with technical equipment',
        },
        isBlueBackground: true,
      },
    ])
...
export type ImageListWithDescriptionSlideData = z.infer<typeof imageListWithDescriptionSlideSchema>;
