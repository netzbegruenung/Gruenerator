...
const tractionSchema = z.object({
  ...
  description: z
    ...
    .meta({
      description: "Main content text describing the company's traction and growth momentum.",
    }),
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <XAxis
                      ...
                      tick={{
                        fill: 'var(--background-text, #234CD9)',
                        fontSize: 12,
                        fontWeight: 600,
                      }}
                    />
            ...
            {data?.tableMode ? (
              <div className="w-full">
                <div
                  ...
                  style={{ borderColor: 'var(--secondary-accent-color, rgba(0,0,0,0.08))' }}
                >
