...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(10)
    .max(150)
    .default('High-quality illustrative image for the left panel of a pitch deck cover')
    .meta({
...
const dynamicSlideLayout: React.FC<LayoutProps> = ({ data: slideData }) => {
  ...
  const brIndex =
    typeof slideData?.titleBreakAfter === 'number' ? (slideData?.titleBreakAfter as number) : 12;
